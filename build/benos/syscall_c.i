...
const syscall_fn_t syscall_table[6] = {
 [0] = (syscall_fn_t)__riscv_sys_open,
 [1] = (syscall_fn_t)__riscv_sys_close,
 [2] = (syscall_fn_t)__riscv_sys_read,
 [3] = (syscall_fn_t)__riscv_sys_write,
 [4] = (syscall_fn_t)__riscv_sys_clone,
 [5] = (syscall_fn_t)__riscv_sys_malloc,
};
